...
├── 3D-Model-Demo-Halloween-clean.glb        # Primary WebXR asset
...
1) Replace or update `3D-Model-Demo-Halloween-clean.glb` with your latest GLB export (animations supported).
2) (Optional, for iOS Quick Look) Generate a matching `3D-Model-Demo-Halloween-clean-1.usdz` and add it to the project root.
